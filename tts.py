...
class TTS:
    ...
    async def generate_tts( self, text: str, *, ssml: bool = False, language_code: str = 'en-US', voice_name: str = 'en-US-Neural2-C', pitch: float | None = None, speed: float | None = None ) -> bytes:
